...
void rundomsound() {
  ...
  if (COUNTER = 0) {
    ...
    playtone_1000(130, 1000, 3, randTime);
    ...
    playtone_10000(1000, 10000, 3, randTime);
    delay_one_tenth_ms(randTime);
    ...
    playtone_20000(10000, 20000, 3, randTime);
    delay_one_tenth_ms(randTime);
...
void delay_one_tenth_ms(unsigned long int ms) {
  ...
  const unsigned long int DelayCount = 103;  // Default: 87 - this value was determined by trial and error
